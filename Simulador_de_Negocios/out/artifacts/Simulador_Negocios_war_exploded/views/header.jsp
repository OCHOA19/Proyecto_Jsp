...
<head>
    ...
    <script>
        function eliminarInversiones(idinversiones)
        {
            var confirmation = confirm(int.fromCharCode(191)+'Est\u00E1 seguro de que desea eliminar la inversion con clave '+ idinversiones);

            if(confirmation)
            {
                window.location = "borrar_inversion.jsp?idinversiones="+idinversiones;
            }
        }
    </script>
</head>
